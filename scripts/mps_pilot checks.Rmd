...
subtitle: $\color{red}{\text{NOT FOR SHARING}}$
...
From January to June 2021, the Metropolitan Police Service (MPS) Deputy Commissioner's Delivery Group and Roads and Transport Policing Command conducted a pilot (**ref to report**) to record the ethnic background of drivers stopped by police under Section 136 of the Road Traffic Act [@participation_road_nodate]. This involved officers asking for and recording the self-defined ethnicity of every driver stopped under Section 163 of the Road Traffic Act. 
